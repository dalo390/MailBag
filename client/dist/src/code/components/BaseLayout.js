...
class BaseLayout extends react_1.Component {
    ...
    render() {
        return (react_1.default.createElement("div", { className: "appContainer" },
            react_1.default.createElement(Dialog_1.default, { open: this.state.pleaseWaitVisible, disableEscapeKeyDown: true, transitionDuration: 0, onClose: (inEvent, inReason) => {
